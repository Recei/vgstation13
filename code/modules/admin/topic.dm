/datum/admins/Topic(href, href_list)
	...
	if(href_list["makeAntag"])
		...
		switch(href_list["simplemake"])
			...
			if("metroid")			M.change_mob_type( /mob/living/carbon/slime/metroid , null, null, delmob )
			if("adultmetroid")		M.change_mob_type( /mob/living/carbon/slime/adult/metroid , null, null, delmob )
