/*
  ...
  !!USE THIS EXAMPLE IF YOU WAN'T TO ADD NEW REAGENT!!
...
*/
/*
	Iamgoofball port of Goon Chem edited by Smet19.
	Uses some of D2K5 reagents code.
	All code is free for use and edit.
*/