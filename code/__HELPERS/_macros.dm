...
#define	ismetroid(A) istype(A, /mob/living/carbon/slime/metroid)

#define	ismetroidadult(A) istype(A, /mob/living/carbon/slime/adult/metroid)
...
#define isboss(H) ((H.mind in ticker.mode.A_bosses) || (H.mind in ticker.mode.B_bosses))

#define isAboss(H) (H.mind in ticker.mode.A_bosses)

#define isBboss(H) (H.mind in ticker.mode.B_bosses)
