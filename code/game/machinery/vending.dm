...
/obj/machinery/vending/medical
	...
	products = list(
		...
		/obj/item/weapon/reagent_containers/glass/bottle/diphenhydramine = 4,
		/obj/item/weapon/reagent_containers/glass/bottle/potass_iodide = 3,
		/obj/item/weapon/reagent_containers/glass/bottle/atropine = 3,
		/obj/item/weapon/reagent_containers/pill/salbutamol = 10,
		/obj/item/weapon/reagent_containers/pill/mannitol = 10,
