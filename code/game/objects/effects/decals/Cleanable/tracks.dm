...
/obj/effect/decal/cleanable/poo/tracks/proc/AddTracks(var/list/DNA, var/comingdir, var/goingdir)
	var/updated=0
	// Shift our goingdir 4 spaces to the left so it's in the GOING bitblock.
	var/realgoing=goingdir<<4
	...
	for(var/bi=0;bi<4;bi++)
		...
		if(comingdir&b)
			...
			if(dirs&b)
				...
				// Remove existing stack entry
				stack.Remove(track)
			track=new /datum/fluidtrack(b,"#402000",t)
			stack.Add(track)
			setdirs["[b]"]=stack.Find(track)
			updatedtracks |= b
			updated=1
...
/obj/effect/decal/cleanable/poo/tracks/update_icon()
	// Clear everything.
	// Comment after the FIXME below is fixed.
...
/obj/effect/decal/cleanable/poo/tracks/footprints
	name = "wet footprints"
	desc = "Whoops..."
	coming_state = "human1"
	going_state  = "human2"
...
/obj/effect/decal/cleanable/poo/tracks/footprints/vox
	coming_state = "claw1"
	going_state  = "claw2"

/obj/effect/decal/cleanable/poo/tracks/wheels
	name = "wet tracks"
	desc = "Whoops..."
	coming_state = "wheels"
	going_state  = ""
