...
*/
	...
	mymob.client.screen += list( mymob.throw_icon, mymob.zone_sel, mymob.oxygen, mymob.pressure, mymob.toxin, mymob.bodytemp, mymob.internals, mymob.fire, mymob.healths, mymob.nutrition_icon, mymob.hydration_icon, mymob.pullin, mymob.blind, mymob.flash, mymob.damageoverlay, mymob.rest) //, mymob.hands, mymob.rest, mymob.sleep) //, mymob.mach )
